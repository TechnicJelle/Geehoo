...
namespace GXPEngine
{
	...
	public class Canvas : Sprite
	{
		...
		public void DrawSprite(Sprite sprite) {
			...
			Vec2 p0 = sprite.TransformPoint(-halfWidth, -halfHeight);
			Vec2 p1 = sprite.TransformPoint(halfWidth, -halfHeight);
			Vec2 p2 = sprite.TransformPoint(-halfWidth, halfHeight);
